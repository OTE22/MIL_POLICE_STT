...
| Suite | Result |
|---|---|
| Central server pytest (isolated PostgreSQL `military_stt_test`) | **53 passed, 0 failed** (includes 13 voice-identification tests) |
| Voice cycle in the browser (enrol gating, re-scan, per-person grouping) | **14/14 PASS** |
